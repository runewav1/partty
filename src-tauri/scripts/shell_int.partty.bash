...
if [[ -n "$BASH_VERSION" ]]; then
  ...
  # `false || true`) would fragment. Capture the full line from history once
  # per interactive line; __partty_interactive_mode (last in PROMPT_COMMAND)
  # re-arms the capture after every prompt.
...
export TERM_PROGRAM_VERSION="${TERM_PROGRAM_VERSION:-0.6.0}"
